...
public class FileSystemStorageService implements StorageService {
    ...
    public void store(MultipartFile file) {
        try {
            ...
            Path basicPath = Paths.get(file.getOriginalFilename());
            // 解析成存储的绝对路径
            Path destinationFile = this.rootLocation.resolve(basicPath).normalize().toAbsolutePath();
