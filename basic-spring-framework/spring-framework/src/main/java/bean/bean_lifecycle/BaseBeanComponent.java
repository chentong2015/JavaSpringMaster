...
// Spring会将该类型视为一个bean
@Component
public class BaseBeanComponent {

    // Field injection is not recommended !
    @Autowired
    private BeanPostConstruct orderService;
    ...
    public BaseBeanComponent(BeanPostConstruct orderService, BeanPostConstruct orderService1) {
        this.orderService1 = orderService;
