...
// 从指定的资源文件路径中批量加载配置的属性
public class MyPropertiesSourceLoader {
    ...
    public void loadPropertiesFromResourceFile(ConfigurableEnvironment environment) throws FileNotFoundException {
        ...
        try {
            List<PropertySource<?>> propertySources = propertiesPropertySourceLoader
                    .load("applicationConfig: serviceConfigurationPath", resource);
